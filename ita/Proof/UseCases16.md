...
ip route change unreachable 10.0.0.24/29 table ntk
ip route change unreachable 10.0.0.88/29 table ntk
ip route change 10.0.0.20/30 table ntk via 169.254.96.141 dev eth1 src 10.0.0.17
ip route change 10.0.0.84/30 table ntk via 169.254.96.141 dev eth1 src 10.0.0.17
ip route change 10.0.0.60/30 table ntk via 169.254.96.141 dev eth1 src 10.0.0.57
