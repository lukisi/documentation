...
iptables -t mangle -A PREROUTING -m mac --mac-source 00:16:3E:3C:14:33 -j MARK --set-mark 250
...
```
ip route flush table ntk_from_00:16:3E:3C:14:33
iptables -t mangle -D PREROUTING -m mac --mac-source 00:16:3E:3C:14:33 -j MARK --set-mark 250
...
e *𝛽* che non è più possibile raggiungere tramite essi l'indirizzo (di livello 1) 1·1·; e che ora è possibile
raggiungere tramite essi l'indirizzo 1·3·.

Questo ETP viene recepito solo dai nodi del g-nodo di livello 2, cioè da *𝛿* che lo propaga a *𝜇*.
