...
al programma. In realtà il QspnManager non ha bisogno di emettere questo segnale, in quanto
già segnala ogni singola variazione della mappa.

Ricordiamo anche che il QspnManager fornisce al programma un metodo che restituisce l'indirizzo
Netsukuku del vicino collegato ad un dato arco-qspn, se ha già ricevuto tramite di esso almeno un ETP.
Al programma serve sapere se il modulo conosce già l'indirizzo Netsukuku del vicino, perché solo
